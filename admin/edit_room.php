	...
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<div class = "alert alert-info">Bouquet</div>
				<br />
				<div class = "col-md-4">
					<?php
					...
					<form method = "POST" enctype = "multipart/form-data">
						...
						<br />
						<div class = "form-group">
							<button name = "edit_room" class = "btn btn-warning form-control"><i class = "glyphicon glyphicon-edit"></i> Enregistrer changement</button>
						</div>
					</form>

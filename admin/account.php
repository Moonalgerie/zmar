...
<body>
	...
	<div class = "container-fluid">
		<ul class = "nav nav-pills">
			...
			<li><a href = "room.php">Bouquets</a></li>
		</ul>
	</div>
	<br />
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<a class = "btn btn-success" href = "add_account.php"><i class = "glyphicon glyphicon-plus"></i> Creat a new account</a>
				<br />
				<br />
...
<script type = "text/javascript">
	function confirmationDelete(anchor){
		var conf = confirm("Voulez vous vraiment supprimmer ce Compte?");
		if(conf){
